...
class Game extends UI {
    ...
    #handleNewGameClick(
        ...
        this.#removeAddCellsEventListeners();
    ...
    #clickCell(cell) {
        ...
        if(this.#revealedcCells === this.#cellsToReveal && !this.#isGameFinished) this.#endGame(true);
    }
